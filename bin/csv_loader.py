...
parser.add_argument("--dsn", help="database to load CSVs to", type=str, default="postgresql://covidb2:covidb2@localhost:5433/covidb2")
parser.add_argument("--schema", help="database schema to load data to", type=str, default='covidb30')
