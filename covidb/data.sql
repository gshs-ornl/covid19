...
$$
    ...
    update static.county set country_id = (select id from static.country where country = 'United States');
...
-- Virginia,600,Fairfax
    INSERT INTO static.fips_lut(state_id, county_id, fips, alt_name)
                select s.id, c.id, c.fips, c.alt_name
